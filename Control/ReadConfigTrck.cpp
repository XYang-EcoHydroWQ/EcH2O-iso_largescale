...
int Control::ReadConfigTrck(string confilename /*= "configTrck.ini"*/)
{
  ...
  try{
    ...
    if(sw_2H){
	  ...
	  Rep_d2Hleakage = ConfigTrck.read<bool>("Rep_d2H_Leakage");
	  RepTs_d2Hleakage = ConfigTrck.read<bool>("Ts_d2H_Leakage");
    ...
    if(sw_18O){
	  ...
	  Rep_d18Oleakage = ConfigTrck.read<bool>("Rep_d18O_Leakage");
	  RepTs_d18Oleakage = ConfigTrck.read<bool>("Ts_d18O_Leakage");
    ...
    if(sw_Age){
	  ...
	  // report value in Extra GW yangx 2020-05
	  Rep_Ageleakage = ConfigTrck.read<bool>("Rep_Age_Leakage");
	  RepTs_Ageleakage = ConfigTrck.read<bool>("Ts_Age_Leakage");
