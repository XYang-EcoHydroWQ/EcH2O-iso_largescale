...
int Control::ReadConfigFile(string confilename /*= "config.ini"*/)
{
    ...
    //extra GW initial parameter and storage. 
	//Extra GW yangx 2020-05
    if (sw_extraGW){	
	...
	Rep_BedRock_leakage = Config.read<bool>("Report_Bedrock_Leakage");
	...
	// Extra GW storage and fluxes yangx 2020-05
	RepTs_BedRock_leakage = Config.read<bool>("Ts_Bedrock_Leakage");
