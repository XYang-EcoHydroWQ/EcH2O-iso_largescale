...
void GenerateConfigTrckTemplate(const char *fn){
  ...
  try {
    ...
    ofOut << "channel_water_frac = 1" << endl << endl;
    ...
    //yangx 2020-05
	ofOut << "Rep_d2H_Leakage = 0" << endl;
	ofOut << "Rep_d18O_Leakage = 0" << endl;
	ofOut << "Rep_Age_Leakage = 0" << endl;
    ...
    ofOut << "Ts_d2Hsurface = 0" << endl;
    ofOut << "Ts_d2Hchan = 0" << endl;
    ...
    //yangx 2020-05
	ofOut << "Ts_d2H_Leakage = 0" << endl;
	ofOut << "Ts_d18O_Leakage = 0" << endl;
	ofOut << "Ts_Age_Leakage = 0" << endl;
