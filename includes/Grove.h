...
struct Grove {
	...
	REAL8 lwp_d; //lwp level for complete closure on stomatal conductance (- m of head)
	REAL8 lwp_c; //lwp level for no hydrologic control on stomatal conductance (- m of head)
